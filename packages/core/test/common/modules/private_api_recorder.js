...
define(['test/support/output_directory_paths'], function (outputDirectoryPaths) {
  const privateAPIIdentifiers = [
    ...
    'call.httpRequester._getHosts',
    'call.httpRequester.checkConnectivity',
    'call.httpRequester.doUri',
    'call.msgpack.decode',
    'call.msgpack.encode',
    ...
    'call.http.baseUri',
    'call.http.httpRequester.do',
    'call.httpChannel._publish',
    ...
    'read.http._currentFallback',
    'read.http._currentFallback.host',
    'read.http._currentFallback.validUntil',
    'read.http.options.key',
    'read.http.options.primaryDomain',
    'read.http.options.token',
    'read.http.serverTimeOffset',
    ...
    'replace.httpRequester.doUri',
    'replace.http.httpRequester.do',
    'replace.http.time',
    'replace.httpChannel._publish',
    ...
    'write.http._currentFallback.validUntil',
  ];
